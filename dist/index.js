...
var corsConfig_1 = __importDefault(require("./middleware/corsConfig"));
...
var tagRoutes_1 = __importDefault(require("./routes/tagRoutes"));
...
mongoose_1.default
    ...
    .then(function () { return app.listen(PORT, function () { return console.log("Server run on port ".concat(PORT)); }); })
